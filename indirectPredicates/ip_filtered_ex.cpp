// Projection-plane and exact normal helpers.
//
// This file used to be compiled as a trailing #include at the bottom of ip_filtered.cpp,
// so it carried no includes of its own and could call that file's helpers directly.
// ip_filtered.cpp is gone -- Indirect_Predicates provides the predicates it held -- so
// this is a translation unit now: it needs the numeric kernel, and it needs the two
// projection helpers below, which have no counterpart upstream and allocate nothing.
